...
//MAYDON BO'SHLIGINI TEKSHIRIB BERUVCHI YORDAMCHI FUNCTION
...
var createContactObject = function( name, surname, phone, relationship){
  ...
  // FUNCTION 4 TA NARSA BERADI ULAR ATRIBYUT QIYMATLARIGA BORGANDAN SO'NG RETURN HAMMASINI 1 TA UMUMMIY OBJECT QILIB  QAYTARADI 
  return{
    ...
    name,
    surname,          // FUNCTION DA BERILGAN NOM ATRIBYUT BN BIR HIL KELSA 1 DONASINI shu tarizda YOZAMIZ
    phone,
    relationship
  };
...
elNewContactForm.addEventListener('submit', function(evt) {
  ...
  //MAYDON BO'SHLIGINI TEKSHIRIB BERUVCHI YORDAMCHI FUNCTIONING ISHLATILISHI
...
//YARATIB BERILGAN OBJECTNI CONTACTS ARRAY GA QO'SHAMIZ
contacts.push(createContactObject(name, surname, phone, relationship));
console.log(contacts);

//SAHIFADA KORSATIB TURGAN CONTACTLARNI O'CHIRIB TASHLASH
elContacts.innerHTML = "";

//CONTACTS YANI ARRAY NI ICHIDAGI HAR BIR CONTACT UCHUN ALOHIDA LI YOZIB SAHIFAGA QOSHAMIZ
for( var i = 0; i < contacts.length; i++){
  ...
  elNewFullNameSername.textContent = `${contacts[i].name} ${contacts[i].surname}`
